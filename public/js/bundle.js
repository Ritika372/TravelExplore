        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: type === 'data' ? 'http://localhost:3000/api/users/updateMe' : 'http://localhost:3000/api/users/updatepassword',
              data: data
            });
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoicml0aWthLTEyMyIsImEiOiJja21nZWRqM2wzZWI2MnVud2Rxd3JkMzJvIn0.fFATZsWgva1xInByO8m9WA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/ritika-123/ckmgew0zj7qst17qls80jw8a2',
    scrollZoom: false //   center: [-118.30756079319706, 34.1443230085797],
    //   zoom:10
  ...
  locations.forEach(function (loc, ind) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day : ".concat(ind + 1, " : ").concat(loc.description, "</p>")).addTo(map);
...
var stripe = Stripe('pk_test_51IZsVGSH8n6QF39M4Um37eeC0hl88n5HFDTHJ4rW0UiFYaWTy4hIxAqOtQu3E6tskIIWYaKrlWEGbduRSGvICqxB009NFvqxq7');
...
if (userSettingsForm) {
  userSettingsForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
      var currpassword, password, passwordConfirm, btnSavePassword;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              btnSavePassword = document.querySelector('.btn--savePassword');
            ...
            case 8:
              btnSavePassword.textContent = 'Save password'; //cleairng fields
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    bookBtn.textContent = 'Processing...'; //console.log(bookBtn.dataset);
