...
if (loginForm) {
  loginForm.addEventListener('submit', function (event) {
    ...
    (0, _login.login)(email, pass); //   console.log(email, pass);
  });
}
